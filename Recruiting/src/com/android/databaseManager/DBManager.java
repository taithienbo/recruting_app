...
public class DBManager {
	...
	// These are the initial database values. 
	private static String database_name = "recruitment_db";
	private static String database_user = "a_user";
	private static String database_pass = "test";
